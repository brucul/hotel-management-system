        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createCategory"><i class="fa fa-plus-circle"></i> Tambah Sub-Kategori</button>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
...
@include('backend.master.subcategory.m_subcategory')
@endsection
