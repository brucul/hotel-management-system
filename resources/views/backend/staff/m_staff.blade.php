...
<section class="content">
	<div class="box box-info">
		...
		<form class="form-horizontal" role="form" action="{{ route('update.acc', $staff->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs" role="tablist" id="myTab">
                                <li class="active"><a href="#currentIssue" role="tab" data-toggle="tab">Edit Profile</a></li>
                                <li><a href="#previousIssue" role="tab" data-toggle="tab">Edit User</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="file-upload col-md-12">
                                                    ...
                                                    <div class="file-upload-content" id="file-upload-content-utama">
                                                        <img class="file-upload-image" src="{{ asset('storage/backend/user/'.$staff->pict) }}" alt="your image" id="file-upload-image-utama" />
                                            ...
                                            <div class="col-md-9"><br/>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="name" class="form-control" id="name" placeholder="Nama" value="{{ $staff->name }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="phone" class="col-sm-2">No. Telp</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="phone" class="form-control" id="phone" placeholder="No. Telp" value="{{ $staff->phone }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="address" class="col-sm-2">Alamat</label>
                                                    <div class="col-sm-10">
                                                        <textarea name="address" class="form-control" id="address">{{ $staff->address }}</textarea>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12"><br/>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{ $staff->user->email }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
